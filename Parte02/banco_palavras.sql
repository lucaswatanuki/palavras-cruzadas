DROP DATABASE IF EXISTS banco_palavras;

CREATE DATABASE banco_palavras;

USE banco_palavras;

ALTER DATABASE banco_palavras CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
INSERT INTO palavras (id, palavra, dica)  VALUES (5, 'COBRA', 'Kevin Durant, Snake em português');
INSERT INTO palavras (id, palavra, dica)  VALUES (6, 'BESOURO', 'Inseto que gruda no cabelo');
INSERT INTO palavras (id, palavra, dica)  VALUES (7, 'SAPO', 'Anfíbio verde');
...
INSERT INTO palavras (id, palavra, dica)  VALUES (12, 'ARROZ', 'Branco e comum nas refeições');
...
INSERT INTO palavras (id, palavra, dica)  VALUES (24, 'WINDOWS', 'Janelas, SO');
INSERT INTO palavras (id, palavra, dica)  VALUES (25, 'LINUX', 'Distribuições, SO');
INSERT INTO palavras (id, palavra, dica)  VALUES (26, 'ANDROID', 'Robozinho');
INSERT INTO palavras (id, palavra, dica)  VALUES (27, 'JAVA', '.lang, Linguagem OO');
INSERT INTO palavras (id, palavra, dica)  VALUES (28, 'PYTHON', 'Linguagem de programacão');
INSERT INTO palavras (id, palavra, dica)  VALUES (29, 'APPLE', 'Empresa ostentação, Maçã');
INSERT INTO palavras (id, palavra, dica)  VALUES (30, 'MICROSOFT', 'M$, Dona do Windows');
...
INSERT INTO palavras (id, palavra, dica)  VALUES (34, 'SANTOS', 'Ninguém liga, time de idoso');
